...
from . import common, translations, templates, exporter, importer, anim, interface, rigger

_MODULES = (common, translations, templates, importer, anim, exporter, interface, rigger)
