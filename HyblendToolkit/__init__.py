...
from . import common, translations, templates, exporter, importer, anim_importer, interface, rigger, anim_tools

_MODULES = (common, translations, templates, importer, anim_importer, exporter, interface, rigger, anim_tools)
