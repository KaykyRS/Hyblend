...
# raiz do pacote (formato de Extension do Blender 4.2+). Se você só recebeu
# ESTE arquivo pra atualizar, não precisa se preocupar com o manifest a
...
from .common import BONE_ORIGINAL_NAME_PROP, FPS_HYTALE, UNIT_SCALE_DEFAULT, quat_to_dict, vec_to_dict
...
CONTROL_SUFFIXES = ("_MCH", "_CTRL", "_IK")
